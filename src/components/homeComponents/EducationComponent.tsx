    ...
    return (
        <div>
          ...
          <div className="w-100 flex pr-2 pl-2 flex-column justify-center">
            ...
            <div className="font-size-16 pt-1 pb-1 text-blackGray">BSc in Computer Science graduate</div>
            <div className="flex justify-between font-size-12 pt-1 pb-1 w-100 text-bold">
            ...
            <div className="font-size-16 pt-3 pb-1 text-blackGray">High School graduate</div>
            <div className="flex justify-between font-size-12 pt-1 pb-1 w-100 text-bold">
              <div>High School of "Sveti Sava", Belgrade</div>
              <div>2014 - 2018</div>
            </div>
            <div className="font-size-16 pt-3 pb-1 text-blackGray">Elementary School graduate</div>
            <div className="flex justify-between font-size-12 pt-1 pb-1 w-100 text-bold">
