...
<div className="flex w-100 h-100 pt-2 pb-2 justify-center">
          <div className="w-100 p-2 flex flex-column  justify-center">
            ...
            <div className="mt-1 font-size-13 text-align-justify">
              {" "}
            ...
            <div className="font-size-16 pt-1 pb-1 text-blackGray">Junior Software Engineer</div>
            <div className="flex justify-between font-size-12 pt-1 pb-1 w-100 text-bold"><div >Factory World Wide, Belgrade</div><div>July 2022 - June 2023</div></div>
            <div className="mt-1 font-size-13 text-align-justify">
            ...
            <div className="font-size-16 pt-3 pb-1 text-blackGray">Part-Time Employee</div>
            <div className="flex justify-between font-size-12 pt-1 pb-1 w-100 text-bold"><div >Part-time Jobs</div><div>2015 - Present Day</div></div>
            <div className="mt-1 font-size-13 text-align-justify">
